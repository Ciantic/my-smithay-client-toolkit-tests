// This is nearly copy-pasted from the wgpu.rs example, but updated to use latest WGPU 27 APIs.
// 
// https://github.com/Smithay/client-toolkit/blob/master/examples/wgpu.rs
